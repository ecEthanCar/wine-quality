...
best = regsubsets(quality~., data = winequality_white, nvmax = 19)
...
```
BIC graph shows that having 8 number of variable has lowest BIC. So we will choose the 
...
calculate_test_error <- function(seed) {
  ...
  trainData <- winequality_white[train_ind, ]
  testData <- winequality_white[-train_ind, ]
...
Result shows that the MSE from using a linear model with 8 predictors chosen from 
